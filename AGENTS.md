...
- **GitHub**: [azizaeffendi/marketingskills](https://github.com/azizaeffendi/marketingskills)
- **Creator**: azizaeffendi
- **License**: MIT
...
1. **Once per session**, on first skill use, check for updates:
   - Fetch `VERSIONS.md` from GitHub: https://raw.githubusercontent.com/azizaeffendi/marketingskills/main/VERSIONS.md
