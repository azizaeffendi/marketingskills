...
- **GitHub**: [azizaeffendi/marketingskils](https://github.com/azizaeffendi/marketingskils)
...
1. **Once per session**, on first skill use, check for updates:
   - Fetch `VERSIONS.md` from GitHub: https://raw.githubusercontent.com/azizaeffendi/marketingskils/main/VERSIONS.md
